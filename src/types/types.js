export const types = {
   ...
   fieldsRemove: '[Field] Remove field',
   fieldsUpdate: '[Field] Update field',
   fieldsValueAdd: '[Field] Add field value',
   ...
   salesPointListSet: '[SalesPoint] Set sales point list',
   salesPointActiveSet: '[SalesPoint] set active sales point'
